...
{
    internal class CalendarPageBehavior : Behavior<ContentPage>
    {
        /*
        #region Fields
        ...
        protected override void OnAttachedTo(ContentPage bindable)
        {
            ...
            (this.editorLayout.BindingContext as EditorLayoutCS).AppointmentModified += this.EditorLayout_AppointmentModified;
